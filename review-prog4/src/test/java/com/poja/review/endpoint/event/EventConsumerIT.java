package com.poja.review.endpoint.event;
...
import com.poja.review.conf.FacadeIT;
import com.poja.review.endpoint.event.gen.UuidCreated;
import com.poja.review.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "com.poja.review.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
